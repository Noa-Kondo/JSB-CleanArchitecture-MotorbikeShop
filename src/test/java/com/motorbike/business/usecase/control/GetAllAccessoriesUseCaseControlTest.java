...
public class GetAllAccessoriesUseCaseControlTest {
    ...
    public void testExecute_ReturnsAllAccessories() {
        ...
        GetAllAccessoriesUseCaseControl control = new GetAllAccessoriesUseCaseControl(presenter, accessoryRepo);
    ...
    public void testExecute_EmptyList() {
        AccessoryRepository accessoryRepo = new AccessoryRepository() {
            @Override
            public java.util.Optional<PhuKienXeMay> findById(Long id) { return java.util.Optional.empty(); }
            @Override
            public PhuKienXeMay save(PhuKienXeMay accessory) { return accessory; }
            @Override
            public List<PhuKienXeMay> findAllAccessories() { return new ArrayList<>(); }
            @Override
    ...
    public void testExecute_RepositoryThrows_SystemError() {
        AccessoryRepository accessoryRepo = new AccessoryRepository() {
            ...
            public PhuKienXeMay save(PhuKienXeMay accessory) { return accessory; }
            @Override
            public List<PhuKienXeMay> findAllAccessories() { throw new RuntimeException("DB down"); }
            @Override
            public void deleteById(Long id) { }
        };
